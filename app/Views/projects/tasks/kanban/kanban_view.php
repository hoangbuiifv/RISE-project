<div id="kanban-wrapper">
    ...
    foreach ($tasks as $task) {
        ...
        if ($task_labels) {
            $task_labels = "<div class='meta float-start'>$task_labels</div>";
        }
        ...
        $item = $exising_items . modal_anchor(get_uri("projects/task_view"), "<span class='avatar'>" .
                        ...
                        "</span>" . $sub_task_icon . $task->id . ". " . $task->title . $toggle_sub_task_icon . $batch_operation_checkbox . "<div class='clearfix'>" . $start_date . $end_date . "</div>" . $kanban_custom_fields_data .
