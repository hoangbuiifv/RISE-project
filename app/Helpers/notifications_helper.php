...
if (!function_exists('get_notification_config')) {
    ...
    function get_notification_config($event = "", $key = "", $info_options = array()) {
        ...
        try {
            $notification_config = app_hooks()->apply_filters('app_filter_notification_config', "");
            if ($notification_config && get_array_value($notification_config, "notification_info")) {
                $events = array_merge($events, get_array_value($notification_config, "notification_info"));
            }
        } catch (\Exception $ex) {
