...
class Plugins extends Security_Controller {
    ...
    function save() {
        ...
        if (!function_exists("zip_open")) {
            echo json_encode(array("success" => false, 'message' => "Please install the zip extension in your server."));
            exit();
        }

        $zip = zip_open($plugin_zip_file);
        ...
        unset($zip); //unset zip extraction variable to delete temp file
